...
form.addEventListener('submit', function(e) {
    ...
    const rindex = (name.length*year)%20;
    const vindex = (day*month*year)%20;

    result.innerHTML = `Hello ${name}, and your zodiac sign is ${zodiacSigns[Math.floor(month-1)]}. ${compliments[day-1]} ${victimCardCompliments[index]} ${predictions[index]} ${recommendations[rindex]} ${predictions[vindex]}`  ;
